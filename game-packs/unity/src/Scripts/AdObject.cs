...
namespace DecentralAds
{
    ...
    public class AdObject : Ad
    {
        ...
        /// Sets the sprite, and adjusts the scale of the frame if width and height are positive.
        /// </summary>
        ...
        protected override void SetData(Sprite sprite, float width, float height)
        {
            ...
            if (width > 0 && height > 0) frame.sizeDelta = new UnityEngine.Vector2(width / 100f, height / 100f);
        }
    }
}
